...
<body>
    ...
    <form action="{{ route('programpendidikan.store') }}" method="POST" enctype="multipart/form-data" class="form-container">
        @csrf
        ...
        <div class="form-group mb-4">
            <label for="">Masukan Tahun Untuk Lulus</label>
        ...
        <div class="form-group mb-4">
            <label for="">Masukan Jumlah Santri Sekarang</label>
        ...
        <div class="form-group mb-4">
            <label for="">Pilih Photo Untuk Ditambahkan Sebagai Foto Program</label>
