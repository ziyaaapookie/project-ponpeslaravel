...
<body>
    ...
    <h1 style="text-align: center;">Halaman Edit Galeri</h1>
    ...
    <form action="{{ route('galeri.update', $galeri->id) }}" method="POST" enctype="multipart/form-data" class="form-container">
        @csrf



        <div class="form-group mb-4">
            <label for="">Pilih Photo Untuk DiGanti</label>
