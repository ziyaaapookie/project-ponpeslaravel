...
<head>
    ...
    <title>Halaman Dashboard Create Staff</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous" />
</head>

<body>

    <h1>Halaman Dashboard Create Staff</h1>

    <div style="text-align: center; margin-bottom: 20px; padding-top:20px;">
        <a href="/staff" class="btn-custom">Kembali Ke Dashboard Staff</a>
    </div>

    <form action="{{ route('staff.store') }}" method="POST" enctype="multipart/form-data" class="form-container">
        @csrf
        ...
        <div class="form-group mb-4">
            <label for="">Pilih Photo Untuk staff</label>
