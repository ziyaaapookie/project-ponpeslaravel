...
<body>
    ...
    <h1 style="text-align: center;">Dashboard Agenda - Pondok</h1>

    <div style="text-align: center; margin-bottom: 20px; padding-top:20px;">
        <a href="/agenda" class="btn-custom">Kembali Dashboard Pondok</a>
    </div>

    <form action="{{ route('agenda.update', $agenda->id) }}" method="POST" enctype="multipart/form-data" class="form-container">
        @csrf
        ...
        <div class="form-group mb-4">
            <label for="">Masukan Nama Kegiatan</label>
        ...
        <div class="form-group mb-4">
            <label for="">Masukan Tempat</label>
        ...
        <div class="form-group mb-4">
            <label for="">Masukan Deskripsi Singkat</label>
