...
<body>
    ...
    <h2>Halaman Dashboard Create Artikel</h2>
    <div style="text-align: center; margin-bottom: 20px; padding-top:20px;">
        <a href="/artikel" class="btn-custom">Kembali ke artikel</a>
    </div>

    <form action="{{ route('artikel.store') }}" method="POST" enctype="multipart/form-data" class="form-container">
        @csrf
        <div class="form-group mb-4">
            <label for="">Masukan Judul Artikel</label>
            <input type="text" class="form-control @error('judulartikel') is-invalid @enderror" name="judulartikel" value="{{ old('judulartikel') }}">
            @error('judulartikel')
        ...
        <div class="form-group mb-4">
            ...
            <input type="text" class="form-control @error('kategoriartikel') is-invalid @enderror" name="kategoriartikel" value="{{ old('kategoriartikel') }}">
        ...
        <div class="form-group mb-4">
            ...
            <input type="text" class="form-control @error('namapembuat') is-invalid @enderror" name="namapembuat" value="{{ old('namapembuat') }}">
            @error('namapembuat')
            <div class="invalid-feedback" style="color: red; font-size: 14px; margin-top: 10px;">
                {{ $message }}
            </div>
